...
const Filterbox = () => {
  ...
  let { categoryfilter, durationfilter, tagfilter ,allitem} = context;
  ...
  const handlefilter = () => {
    ...
    console.log('the new items are ',allitem)
  }
  ...
  return (
    <div id='Filterbox' style={style1} className='d-flex justify-content-around align-items-center'>
      ...
      <button type="button" class="btn btn-dark" onClick={handlefilter}>Apply filter</button>
    </div>
  )
}
